package com.drawer.acas.fragments;
...
public class toggle_demo extends Fragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.toggle_demo, container, false);
        ...
        toggleButton.setOnCheckedChangeListener(toggle_demo.this);
        toggleSwitch.setOnCheckedChangeListener(toggle_demo.this);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        Toast.makeText(toggle_demo.this.getActivity(), messsage, Toast.LENGTH_SHORT).show();
    }
